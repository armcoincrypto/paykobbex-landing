...
export default function GuidePaymentLifecyclePage() {
  return (
    <>
      ...
      <GuideLayout
        ...
        definitions={
          <p className="text-sm text-muted">
            Definitions: <Link href="/glossary#payment-lifecycle">Payment lifecycle</Link> ·{" "}
      ...
      >
        <GuideSection id="what-is-payment-lifecycle" title="What is a payment lifecycle?" index="01">
        ...
        <GuideSection id="why-payment-lifecycle-matters" title="Why does the lifecycle matter?" index="02">
          <p className="text-sm leading-relaxed text-muted sm:text-body">
        ...
        <GuideSection id="how-payment-lifecycle-works" title="How does the lifecycle work in practice?" index="03">
          <p className="text-sm leading-relaxed text-muted sm:text-body">
        ...
        <GuideSection id="common-mistakes-lifecycle" title="Common mistakes" index="04">
        ...
        <GuideSection id="security-considerations-lifecycle" title="Security considerations" index="05">
          <p className="text-sm leading-relaxed text-muted sm:text-body">
