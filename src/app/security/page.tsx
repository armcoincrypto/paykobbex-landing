...
export default function SecurityPage() {
  return (
    <div className="ops-security">
      ...
      <Section tone="muted" className="ops-security-body pb-[var(--token-section-loose)]">
        <Container className="max-w-content">
          <div className="ops-security-sections">
            <VerificationFramePanel label="Trust boundary" sublabel="Non-negotiable">
              <h2 className="ops-security-panel-title text-primary">Never share secrets with anyone</h2>
              <p className="ops-security-panel-lead text-sm leading-relaxed text-muted">
            ...
            <OperationalGovernancePanel className="ops-security-feature" limit={4} />

            <div className="ops-security-feature-grid">
            ...
            <ConstraintDiscipline className="ops-security-feature" />
